...
namespace Tests\Unit\NamespaceableTestCaseClass\Methods\SetNamespace\Parameters;
...
class NamespaceTest extends TestCase
{
    ...
    public function test_should_have_string_dataType():void {
        ...
        if ($parameterReflection->hasType()) {
            ...
            $types = implode('|',$types);
            $this->assertEquals($expect,$types,"parameter $$this->parameter in $this->method() method from $this->namespace class should have $expect dataType but is $types ");
        }
        else
            $this->fail("parameter $$this->parameter in method $this->method() from $this->namespace class should have any type !!! currently no type hinted ");
    }
    public function test_no_have_default_value():void {
        $parameterReflection = new \ReflectionParameter([$this->namespace,$this->method],$this->parameter);
        $isNoHaveDefaultValue = !$parameterReflection->isDefaultValueAvailable();
        $this->assertTrue($isNoHaveDefaultValue,"parameter $$this->parameter from method $this->method() in $this->namespace class should no have any value !!!");
    }
    public function test_cant_Be_nullalbe():void {
        ...
        $this->assertTrue($cantNull,"parameter $$this->parameter in method $this->method() from $this->namespace class cant nullable !!!");
    }
}
