...
namespace Tests\Unit\NamespaceableEntityTestCaseTrait\Methods\SetNamespace;
...
class SetNamespaceTest extends TestCase
{
    ...
    public function test_is_exist():void {
        ...
        $this->assertTrue($isExist,"method $this->method() in $this->namespace trait is missing ");
    }
    ...
    public function test_is_no_static():void {
        ...
        $this->assertTrue($isNotStatic,"method $this->method() in $this->namespace trait dont be static !!!");
    }
