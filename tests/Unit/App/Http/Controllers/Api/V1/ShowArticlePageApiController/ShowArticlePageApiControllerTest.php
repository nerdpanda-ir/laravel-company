...
namespace Tests\Unit\App\Http\Controllers\Api\V1\ShowArticlePageApiController;
...
class ShowArticlePageApiControllerTest extends TestCase
{
    ...
    public function test_should_implement_ShowArticlePageApiControllerContract():void {
        ...
        $selfImplements = class_implements($this->namespace);
        $diff = array_diff($selfImplements,$parentImplements);
        $interface = ShowArticlePageApiControllerContract::class ;
