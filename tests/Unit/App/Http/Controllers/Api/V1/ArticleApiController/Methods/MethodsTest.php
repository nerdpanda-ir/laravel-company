...
namespace Tests\Unit\App\Http\Controllers\Api\V1\ArticleApiController\Methods;
...
class MethodsTest extends TestCase
{
    ...
    public function test_no_have_private_methods():void {
        ...
        $expect = 0 ;
        $message = '' ;
        //@todo this functionality is duplicated in test cases should create one function for handle this !!!
