...
class NoPrefixableRouteTestCase extends RouteTestCase {
    ...
    protected function assertValueForHeaderInReceivedGetResponseFromRequestToPageRouteByRouteNameEqualTo(
    ...
    protected function assertValueForContentTypeHeaderInReceivedGetResponseFromRequestToPageRouteByRouteNameEqualTo(
