...
class PrefixableRouteTestCase extends RouteTestCase {
    ...
    protected function assertValueForHeaderInReceivedGetResponseFromRequestToFullPageRouteByRouteNameEqualTo(
    ...
    protected function
     assertValueForContentTypeHeaderInReceivedGetResponseFromRequestToFullPageRouteByRouteNameEqualTo(
